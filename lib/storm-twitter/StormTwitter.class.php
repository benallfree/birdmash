 ...
 *
 * This class provides all the things needed for the WordPress plugin, but in
 * theory means you don't need to use it with WordPress. What could go wrong?
 *
 * @version 2.1.3
 * @link https://github.com/stormuk/storm-twitter The StormTwitter repository on GitHub.
 */
...
class StormTwitter {
	...
	function getTweets( $screenname = false, $count = 20, $options = false ) {
		...
		if ( $screenname === false || $screenname === 20 ) {
